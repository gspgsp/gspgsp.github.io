import{_ as n,c as a,d as e,o as l}from"./app-D-RZAT3H.js";const p={};function i(t,s){return l(),a("div",null,s[0]||(s[0]=[e(`<p>larave模型中的几个小技巧:<br></p><p>①模型中关于 $dates 和 $dateFormat<br></p><p>//将 [] 中自定的字段，转为 Carbon 类的时间对象，可以使用 Carbon 的方法，比如：$data-&gt;deleted_at-&gt;getTimestamp()；默认 created_at 和 updated_at 都已经转过了，就不用在 [] 里 写了 protected $dates = [&#39;deleted_at&#39;];</p><p>//定义时间存储到数据的格式，默认 &#39;Y-m-d H:i:s&#39; protected $dateFormat = &#39;Y-m-d H:i&#39;;</p><p>②模型中关于scope的使用，主要有两种使用方式:<br></p><div class="language-php line-numbers-mode" data-highlighter="prismjs" data-ext="php" data-title="php"><pre><code><span class="line"></span>
