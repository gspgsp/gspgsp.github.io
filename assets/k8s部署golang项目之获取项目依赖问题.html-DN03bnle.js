import{_ as s,c as i,e as l,o as e}from"./app-Dma7cYut.js";const a={};function c(d,n){return e(),i("div",null,n[0]||(n[0]=[l(`<p>k8s部署golang项目之获取项目依赖问题:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">docker build golang项目的时候，需要获取go程序的依赖，可能会有如下的问题:</span>
