import{_ as s,c as n,d as a,o as l}from"./app-6NtL0T-y.js";const i={};function t(r,e){return l(),n("div",null,e[0]||(e[0]=[a(`<p>vue3下使用ref调用子组件方法的时候对ts类型的判断:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">//paraernt.vue下调用子组件 UserDashboardEventSeriesTable.vue</span>
