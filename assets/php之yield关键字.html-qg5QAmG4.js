import{_ as s,c as e,d as i,o as a}from"./app-w2t_O-QA.js";const l={};function d(p,n){return a(),e("div",null,n[0]||(n[0]=[i(`<p>php之yield关键字:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">这个关键字的学名是 生成器，任何包含 yield 的函数都是一个生成器函数。</span>
