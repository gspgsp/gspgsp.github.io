import{_ as s,c as n,e as a,o as i}from"./app-BmmNByms.js";const l={};function r(t,e){return i(),n("div",null,e[0]||(e[0]=[a(`<p>mysql之having和where小区别:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">结论：having是从前筛选的字段再筛选，而where是从数据表中的字段直接进行的筛选的</span>
