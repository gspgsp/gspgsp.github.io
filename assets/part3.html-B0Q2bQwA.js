import{_ as n,c as e,f as i,o as a}from"./app-B1ovLvDn.js";const l={};function d(c,s){return a(),e("div",null,s[0]||(s[0]=[i(`<h4 id="整个登陆模块主要涉及两个表-users-和-refresh-tokens" tabindex="-1"><a class="header-anchor" href="#整个登陆模块主要涉及两个表-users-和-refresh-tokens"><span>整个登陆模块主要涉及两个表 users 和 refresh_tokens</span></a></h4><h5 id="_1-users表" tabindex="-1"><a class="header-anchor" href="#_1-users表"><span>1.users表</span></a></h5><ul><li>1.在~/Entity/下定义User.php</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">&lt;?php</span>
