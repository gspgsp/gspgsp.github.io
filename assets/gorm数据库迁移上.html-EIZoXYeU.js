import{_ as s,c as a,d as t,o as e}from"./app-DFQa3UXW.js";const l={};function i(p,n){return e(),a("div",null,n[0]||(n[0]=[t(`<p>gorm数据库迁移上:</p><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line">	<span class="token comment">//简单数据库迁移,这个是比较简单的迁移操作(单表迁移)</span></span>
