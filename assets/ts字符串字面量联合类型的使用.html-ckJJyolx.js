import{_ as n,c as e,d as t,o as i}from"./app-B4P9BclZ.js";const a={};function l(o,s){return i(),e("div",null,s[0]||(s[0]=[t(`<p>ts字符串字面量联合类型的使用:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">direction.ts:</span>
