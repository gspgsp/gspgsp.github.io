import{_ as n,c as l,d as i,o as a}from"./app-CgWRetu1.js";const e={};function t(d,s){return a(),l("div",null,s[0]||(s[0]=[i(`<p>tailwindcss自定义css样式覆盖:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">有如下自定义样式:</span>
