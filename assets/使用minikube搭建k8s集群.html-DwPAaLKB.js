import{_ as n,c as e,f as l,o as a}from"./app-Bo0mKrta.js";const i={};function d(c,s){return a(),e("div",null,s[0]||(s[0]=[l(`<p>使用minikube搭建k8s集群:</p><h3 id="安装kubectl" tabindex="-1"><a class="header-anchor" href="#安装kubectl"><span>安装kubectl</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">https://kubernetes.io/docs/tasks/tools/install-kubectl-linux/</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="配置docker-cli代理" tabindex="-1"><a class="header-anchor" href="#配置docker-cli代理"><span>配置docker cli代理</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">vim  ~/.docker/config.json</span>
<span class="line">{</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,23)]))}const t=n(i,[["render",d],["__file","使用minikube搭建k8s集群.html.vue"]]),r=JSON.parse('{"path":"/content/service/k8s/%E4%BD%BF%E7%94%A8minikube%E6%90%AD%E5%BB%BAk8s%E9%9B%86%E7%BE%A4.html","title":"使用minikube搭建k8s集群","lang":"en-US","frontmatter":{"sidebar":false,"title":"使用minikube搭建k8s集群","description":"使用minikube搭建k8s集群"},"headers":[{"level":3,"title":"安装kubectl","slug":"安装kubectl","link":"#安装kubectl","children":[]},{"level":3,"title":"kubectl常规命令","slug":"kubectl常规命令","link":"#kubectl常规命令","children":[]},{"level":3,"title":"配置docker cli代理","slug":"配置docker-cli代理","link":"#配置docker-cli代理","children":[]},{"level":3,"title":"使用minikube搭建k8s集群","slug":"使用minikube搭建k8s集群","link":"#使用minikube搭建k8s集群","children":[]},{"level":3,"title":"使用minikube搭建的k8s，搭建 redis 集群","slug":"使用minikube搭建的k8s-搭建-redis-集群","link":"#使用minikube搭建的k8s-搭建-redis-集群","children":[]},{"level":3,"title":"StatefulSet的作用","slug":"statefulset的作用","link":"#statefulset的作用","children":[]},{"level":3,"title":"StatefulSet 的使用场景","slug":"statefulset-的使用场景","link":"#statefulset-的使用场景","children":[]},{"level":3,"title":"StatefulSet 的行为","slug":"statefulset-的行为","link":"#statefulset-的行为","children":[]},{"level":3,"title":"StatefulSet vs Deployment","slug":"statefulset-vs-deployment","link":"#statefulset-vs-deployment","children":[]}],"git":{},"filePathRelative":"content/service/k8s/使用minikube搭建k8s集群.md"}');export{t as comp,r as data};
