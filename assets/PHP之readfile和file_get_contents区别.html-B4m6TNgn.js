import{_ as n,c as s,e as i,o as l}from"./app-D1dWqsSN.js";const a={};function t(c,e){return l(),s("div",null,e[0]||(e[0]=[i(`<p>readfile和file_get_contents都是用于读取文件内容的PHP函数，但它们之间有一些关键的区别。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">返回值：</span>
