import{_ as s,c as e,d as i,o as a}from"./app-CN0Zwmz6.js";const l={};function c(d,n){return a(),e("div",null,n[0]||(n[0]=[i(`<p>golang之rune类型:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">字符串中的每一个元素叫做“字符”，在遍历或者单个获取字符串元素时可以获得字符</span>
