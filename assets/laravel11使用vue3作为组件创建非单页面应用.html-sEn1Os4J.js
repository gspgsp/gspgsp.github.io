import{_ as n,c as e,e as l,o as a}from"./app-CDR1p_t7.js";const i={};function p(v,s){return a(),e("div",null,s[0]||(s[0]=[l(`<p>laravel11使用vue3作为组件创建非单页面应用:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">// laravel11默认使用vite打包，相关配置在vite.config.js下</span>
