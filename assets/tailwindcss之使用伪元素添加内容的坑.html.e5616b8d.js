import{_ as e,o as n,c as s,g as i}from"./app.6e4bf74b.js";const a={},l=i(`<p>tailwindcss\u4E4B\u4F7F\u7528\u4F2A\u5143\u7D20\u6DFB\u52A0\u5185\u5BB9\u7684\u5751:</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>:deep(.select-none) {
    @apply text-[0px];
    &amp;::before {
      @apply text-base
