import{_ as e,c as n,e as t,o as i}from"./app-BmmNByms.js";const a={};function l(d,s){return i(),n("div",null,s[0]||(s[0]=[t(`<p>postgressql的基本使用:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">简单的几个使用sql语句：</span>
