import{_ as n,c as e,e as a,o as i}from"./app-D96idk2w.js";const l={};function d(c,s){return i(),e("div",null,s[0]||(s[0]=[a(`<h4 id="gitlab之server端hook配置-主要有两种方式" tabindex="-1"><a class="header-anchor" href="#gitlab之server端hook配置-主要有两种方式"><span>gitlab之server端hook配置，主要有两种方式</span></a></h4><ul><li>server端，全局配置</li><li>server端，为指定仓库配置</li></ul><h5 id="本次我通过为指定仓库配置" tabindex="-1"><a class="header-anchor" href="#本次我通过为指定仓库配置"><span>本次我通过为指定仓库配置</span></a></h5><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">1.进入docker容器</span>
