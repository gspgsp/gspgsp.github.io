import{_ as n,c as a,d as e,o as i}from"./app-DFQa3UXW.js";const t={};function l(p,s){return i(),a("div",null,s[0]||(s[0]=[e(`<p>git提交的OPEN_SSL和Time_Out问题以及解决办法:</p><div class="language-git line-numbers-mode" data-highlighter="prismjs" data-ext="git" data-title="git"><pre><code><span class="line"><span class="token command">$ git push<span class="token parameter"> -u</span> origin master  </span></span>
