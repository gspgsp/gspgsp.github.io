import{_ as e,c as n,h as a,o as i}from"./app-CoqXlDb9.js";const l={};function t(c,s){return i(),n("div",null,s[0]||(s[0]=[a(`<p>一直在定义 监听或者订阅 的配置文件用到这个，就记录一下 这个参数的意义</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">Service tags are a way to tell Symfony or other third-party bundles that your service should be registered in some special way. Take the following example:</span>
