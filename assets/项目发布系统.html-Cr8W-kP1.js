import{_ as n,c as e,f as a,o as i}from"./app-BoRu8sPN.js";const l={};function d(c,s){return i(),e("div",null,s[0]||(s[0]=[a(`<h5 id="项目发布系统-将当前项目发送到不同的服务器" tabindex="-1"><a class="header-anchor" href="#项目发布系统-将当前项目发送到不同的服务器"><span>项目发布系统(将当前项目发送到不同的服务器)</span></a></h5><h5 id="_1-环境准备" tabindex="-1"><a class="header-anchor" href="#_1-环境准备"><span>1.环境准备</span></a></h5><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">ubuntu22(宿主机)</span>
