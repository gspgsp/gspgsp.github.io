import{_ as s,c as e,e as a,o as l}from"./app-Dma7cYut.js";const i={};function r(p,n){return l(),e("div",null,n[0]||(n[0]=[a(`<p>docker_compose网络设置:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">通过分析docker-compose.yml文件发现其中有关于网络设置，如下:</span>
