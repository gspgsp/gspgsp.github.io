import{_ as e,c as n,e as a,o as i}from"./app-CDR1p_t7.js";const l={};function t(c,s){return i(),n("div",null,s[0]||(s[0]=[a(`<p>k8s集群配置HTTPS访问: 主要是要配置一个Secret的资源，通过yaml文件配置(不想通过命令行)，格式如下：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">apiVersion: v1</span>
