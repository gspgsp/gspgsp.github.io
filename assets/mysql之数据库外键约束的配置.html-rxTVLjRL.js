import{_ as n,c as e,d as a,o as i}from"./app-DFQa3UXW.js";const l={};function d(t,s){return i(),e("div",null,s[0]||(s[0]=[a(`<p>mysql之数据库外键约束的配置:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">关于数据库外键约束的配置，常见的会给 onDelete 配置一些操作，比如: onDelete: &#39;CASCADE&#39;</span>
