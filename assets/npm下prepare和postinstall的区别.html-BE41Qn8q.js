import{_ as n,c as e,d as a,o as l}from"./app-DpMqoNb1.js";const i={};function p(t,s){return l(),e("div",null,s[0]||(s[0]=[a(`<p>npm下prepare和postinstall的区别:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">1&gt;这两个钩子都是在npm install 完成之后执行</span>
