import{_ as n,c as a,d as l,o as e}from"./app-Cl2rcTth.js";const i={};function d(t,s){return e(),a("div",null,s[0]||(s[0]=[l(`<p>ollama本地初次尝试使用:</p><ul><li>安装</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">$ curl -fsSL https://ollama.com/install.sh | sh</span>
