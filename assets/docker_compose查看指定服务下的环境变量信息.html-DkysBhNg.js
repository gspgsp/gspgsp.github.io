import{_ as n,c as a,d as e,o as i}from"./app-De-UIJv6.js";const l={};function c(p,s){return i(),a("div",null,s[0]||(s[0]=[e(`<p>docker_compose查看指定服务下的环境变量信息:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">在docker-compsoe.yml同级目录下执行</span>
