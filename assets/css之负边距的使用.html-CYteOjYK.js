import{_ as n,c as a,h as l,o as i}from"./app-DUSazZNT.js";const e={};function c(p,s){return i(),a("div",null,s[0]||(s[0]=[l(`<p>当子元素被限定在父元素以内，想要突破父元素的约束，可以按照下面的方式解决</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">&lt;AppSeparator class=&quot;-mx-[4.5rem] w-[calc(100%+9rem)]&quot; /&gt;</span>
