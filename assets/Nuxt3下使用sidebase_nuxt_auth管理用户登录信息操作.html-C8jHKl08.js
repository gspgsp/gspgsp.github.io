import{_ as s,c as e,e as a,o as i}from"./app-CDR1p_t7.js";const l={};function t(d,n){return i(),e("div",null,n[0]||(n[0]=[a(`<p>Nuxt3下使用@sidebase_nuxt-auth管理用户登录信息操作:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">  auth: {</span>
