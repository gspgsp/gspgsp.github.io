import{_ as s,c as n,f as a,o as i}from"./app-CpoMCvnG.js";const l={};function t(c,e){return i(),n("div",null,e[0]||(e[0]=[a(`<p>关于git的reset无效的场景:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">关于 git reset --hard HEAD^ 无效的一种场景:</span>
