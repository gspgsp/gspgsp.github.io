import{_ as n,c as a,d as i,o as l}from"./app-DNwsX6Hl.js";const e={};function v(d,s){return l(),a("div",null,s[0]||(s[0]=[i(`<p>css之vm_vh_lvm_lvh的差别:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">大部分前端都知道，在 CSS 世界中，有 vw、vh、vmax、vmin 这几个与视口 Viewport 相关的单位。</span>
