import{_ as s,c as a,d as e,o as i}from"./app-oOCUwQgj.js";const l={};function c(r,n){return i(),a("div",null,n[0]||(n[0]=[e(`<p>大部分时候，需要自定义wangeditor上传以后的json返回值的格式,注意本版号，下面这个是基于V4版本:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">//默认格式</span>
