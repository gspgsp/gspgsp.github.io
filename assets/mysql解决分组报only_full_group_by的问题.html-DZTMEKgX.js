import{_ as i,c as _,e as c,a as n,o as t,r as l}from"./app-D96idk2w.js";const d={};function r(o,s){const e=l("BackBtn"),a=l("CommentService");return t(),_("div",null,[s[0]||(s[0]=c(`<p>mysql8解决分组报only_full_group_by的问题:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">mysql8下执行group操作，会报下面的错误，5.7以上都会，只是sql_mode的参数略有不同,具体看下面的注释</span>
