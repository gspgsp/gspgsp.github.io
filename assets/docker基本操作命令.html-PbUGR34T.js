import{_ as s,c as n,e as a,o as l}from"./app-CBlpnRTs.js";const i={};function r(d,e){return l(),n("div",null,e[0]||(e[0]=[a(`<p>docker基本操作命令:</p><ul><li>删除所有镜像:</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">docker rmi $(docker images -q)</span>
