import{_ as n,c as i,d as a,o as l}from"./app-C7j_h9cy.js";const e={};function c(p,s){return l(),i("div",null,s[0]||(s[0]=[a(`<p>nuxt3下封装公共http请求:<br> 在实际使用nuxt3请求接口的时候，我默认使用的是 useFetch 请求接口，但是有一种情况会失败，就是在created的时候调用的接口， 我后来分析了一下，useFetch其实是以恶搞client端的请求方式，可能在created的时候，页面还没有渲染完全，所以会报错，后来 找到了三种方法解决这个问题，下面一一介绍(这个问题和之前的 解决Nuxt项目中发生在服务端的请求丢失Cookie的问题 一样):</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">1.改用 $fetch请求接口  </span>
