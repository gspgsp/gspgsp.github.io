import{_ as s,c as e,d as l,o as i}from"./app-CUXG6XT6.js";const a={};function d(c,n){return i(),e("div",null,n[0]||(n[0]=[l(`<p>vue3父组件调用子组件中的方法:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">我在子组件里定义的 const someMethod = () =&gt; {} 可以被调用吗</span>
