import{_ as n,c as e,h as a,o as l}from"./app-DaSvejJ2.js";const i={};function c(v,s){return l(),e("div",null,s[0]||(s[0]=[a(`<p>symfony5之环境变量和配置文件的关系:<br> 最近在项目上线的时候，遇到个问题，配置环境变量，然年后针对不同环境变量，配置不同的数据库参数</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">关于symfony5的环境变量配置文件的一些注意事项:</span>
