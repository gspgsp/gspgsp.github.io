import{_ as e,c as n,d as i,o as a}from"./app-CgWRetu1.js";const l={};function t(r,s){return a(),n("div",null,s[0]||(s[0]=[i(`<p>symfony之user-role权限管理原理:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">symfony的用户角色权限管理和java的差不多，都是通过 注释路由 来控制的，我还是觉得像 laravel下的 RBAC 权限控制系统比较好，更全面</span>
