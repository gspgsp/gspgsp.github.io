import{_ as n,c as e,d as i,o as a}from"./app-CUXG6XT6.js";const l={};function t(d,s){return a(),e("div",null,s[0]||(s[0]=[i(`<p>记录一个关于lint-staged 配合 prettier使用的例子:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">1&gt;在package.json下添加如下依赖</span>
