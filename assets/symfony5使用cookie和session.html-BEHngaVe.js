import{_ as n,c as e,h as i,o as a}from"./app-BduoCxtC.js";const l={};function o(t,s){return a(),e("div",null,s[0]||(s[0]=[i(`<p>关于symfony的session和cookie</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">Symfony HttpFoundation component provides cookie and session management in an object-oriented manner. </span>
