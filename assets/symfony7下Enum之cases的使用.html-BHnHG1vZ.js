import{_ as n,c as e,f as a,o as i}from"./app-CH7Qivnc.js";const l={};function c(t,s){return i(),e("div",null,s[0]||(s[0]=[a(`<h5 id="symfony7下enum之cases的使用" tabindex="-1"><a class="header-anchor" href="#symfony7下enum之cases的使用"><span>symfony7下Enum之cases的使用</span></a></h5><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">&lt;?php</span>
