import{_ as n,c as a,d as e,o as l}from"./app-BwdTcedb.js";const i={};function t(p,s){return l(),a("div",null,s[0]||(s[0]=[e(`<p>最近抽时间看了k8s的Gateway Api部分，在这里记录一下:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">1.GatewayClass定义了一组共享共同配置和行为的网关。每个GatewayClass将由一个控制器处理，尽管控制器可以处理一个以上的GatewayClass。//所以可以看到每个GatewayClass的spec的controllerName会指定一个ateway-api的实现，比如Kong的(kic)</span>
