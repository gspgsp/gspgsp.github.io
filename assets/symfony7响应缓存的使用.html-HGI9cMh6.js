import{_ as n,c as e,d as a,o as i}from"./app-DpMqoNb1.js";const l={};function c(p,s){return i(),e("div",null,s[0]||(s[0]=[a(`<p>symfony7响应缓存的使用: 目前使用symfony7做后台API的开发，部分接口会做响应缓存，基于 Caching Interface， 这个是PSR-6的标准: https://www.php-fig.org/psr/psr-6/</p><p>关于php的标准(PSR:PHP Standards Recommendations): https://www.php-fig.org/</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">//cache配置</span>
