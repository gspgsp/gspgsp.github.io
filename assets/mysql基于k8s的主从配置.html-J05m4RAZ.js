import{_ as n,c as a,d as l,o as e}from"./app-B4P9BclZ.js";const i={};function c(d,s){return e(),a("div",null,s[0]||(s[0]=[l(`<p>mysql基于k8s的主从配置:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">使用minikube 搭建mysql8.0的集群，一个主节点两个从节点</span>
