import{_ as n,c as i,f as a,o as l}from"./app-CH7Qivnc.js";const e={};function d(c,s){return l(),i("div",null,s[0]||(s[0]=[a(`<p>tailwindcss之动态添加屏幕类的坑:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">1&gt;本来想动态修改 lg 条件下，div的宽度, 如下，但是不生效</span>
