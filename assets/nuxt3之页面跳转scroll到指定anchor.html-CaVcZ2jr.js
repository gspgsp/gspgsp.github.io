import{_ as n,c as e,h as l,o as a}from"./app-CqY28rTh.js";const i={};function t(c,s){return a(),e("div",null,s[0]||(s[0]=[l(`<p>nuxt3之页面跳转scroll到指定anchor: 开始看了:https://stackoverflow.com/questions/73932280/nuxt-3-smooth-scrolling-with-hash-links<br> 但是上面这个方法并没有生效</p><p>最后自己想到一个好的方法:<br> 在 created 下定义</p><div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre><code><span class="line">if (process.client) {</span>
