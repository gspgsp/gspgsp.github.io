import{_ as n,c as e,d as a,o as l}from"./app-XuydCqKy.js";const i={};function t(c,s){return l(),e("div",null,s[0]||(s[0]=[a(`<h5 id="lodash下的clamp使用" tabindex="-1"><a class="header-anchor" href="#lodash下的clamp使用"><span>lodash下的clamp使用</span></a></h5><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">watch(</span>
