import{_ as n,c as l,f as i,o as a}from"./app-B1ovLvDn.js";const e={};function p(d,s){return a(),l("div",null,s[0]||(s[0]=[i(`<p>vue3组件使用技巧:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">//有如下自组件，假如为 Child.vue</span>
