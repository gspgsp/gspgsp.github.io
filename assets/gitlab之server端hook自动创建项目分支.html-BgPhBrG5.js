import{_ as n,c as a,f as e,o as i}from"./app-B1ovLvDn.js";const l={};function d(p,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h4 id="gitlab之server端hook自动创建项目分支" tabindex="-1"><a class="header-anchor" href="#gitlab之server端hook自动创建项目分支"><span>gitlab之server端hook自动创建项目分支</span></a></h4><ul><li>之前已经搭建了gitlab下的server hook，做了简单的测试，是可以生效的，接下来准备通过这个hook实现，代码分支的自动发布</li><li>思路如下:</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">1.在gitlab的server的post-receive下定义一个脚本</span>
