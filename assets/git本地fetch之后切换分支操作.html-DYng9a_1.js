import{_ as n,c as s,e as i,o as t}from"./app-DhQfOs3H.js";const a={};function l(c,e){return t(),s("div",null,e[0]||(e[0]=[i(`<p>git本地fetch之后切换分支操作:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">1.一般会在本地执行git fetch, 会把远程最新的分支拉下来</span>
