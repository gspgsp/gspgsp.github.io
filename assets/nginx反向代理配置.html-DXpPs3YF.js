import{_ as e,c as s,e as i,o as a}from"./app-C1QI54RW.js";const l={};function t(r,n){return a(),s("div",null,n[0]||(n[0]=[i(`<p>nginx反向代理配置:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">#pass requests to port 4444 which is used by the Dockerized version of the Web App v2</span>
