import{_ as n,c as e,d as l,o as i}from"./app-CKdWJ1Qk.js";const a={};function p(t,s){return i(),e("div",null,s[0]||(s[0]=[l(`<p>记录一个由php正则引起的问题:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">//有如下内容，需要正则匹配 Reviewer comments 后的内容，但是开始没有考虑到回车的问题，所以导致匹配内容为空的问题</span>
