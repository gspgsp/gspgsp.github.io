import{_ as n,c as a,d as l,o as e}from"./app-CN0Zwmz6.js";const i={};function c(p,s){return e(),a("div",null,s[0]||(s[0]=[l(`<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">在laravel开发项目的时候，有时候需要更新指定的包的版本，尤其是自定义的composer 包的内容发生了变化，那么就需要更新才能使用新的属性或者方法,</span>
