import{_ as n,c as e,h as a,o as i}from"./app-CoqXlDb9.js";const l={};function d(c,s){return i(),e("div",null,s[0]||(s[0]=[a(`<p>HttP之PATCH请求，这个平时用的不是很多，所以这里记录一下</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">1.PUT 和 PATCH  </span>
