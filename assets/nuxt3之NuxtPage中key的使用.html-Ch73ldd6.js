import{_ as n,c as s,e as a,o as t}from"./app-C1QI54RW.js";const i={};function l(u,e){return t(),s("div",null,e[0]||(e[0]=[a(`<p>nuxt3之NuxtPage中key的使用:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">For example, passing static key, NuxtPage component is rendered only once when it is mounted.</span>
