import{_ as n,c as l,f as e,o as a}from"./app-CZhJCr9M.js";const t={};function i(d,s){return a(),l("div",null,s[0]||(s[0]=[e(`<h3 id="父组件使用子组件的slot属性小总结" tabindex="-1"><a class="header-anchor" href="#父组件使用子组件的slot属性小总结"><span>父组件使用子组件的slot属性小总结</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">只有一个default slot的时候</span>
