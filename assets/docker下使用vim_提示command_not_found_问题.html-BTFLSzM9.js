import{_ as e,c as s,f as a,o as i}from"./app-WR18URC5.js";const t={};function l(d,n){return i(),s("div",null,n[0]||(n[0]=[a(`<p>docker下使用vim，提示 command not found 问题:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line"># vim qh.conf.template </span>
