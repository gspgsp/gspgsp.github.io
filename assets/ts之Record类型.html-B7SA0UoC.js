import{_ as n,c as e,d as a,o as i}from"./app-CgWRetu1.js";const l={};function c(t,s){return i(),e("div",null,s[0]||(s[0]=[a(`<p>ts之Record类型:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">Record是TypeScript中的一个实用工具类型。它用于创建一个对象类型，其属性键为K类型，属性值为T类型。Record的基本语法如下：</span>
