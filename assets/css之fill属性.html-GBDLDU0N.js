import{_ as n,c as l,d as i,o as e}from"./app-CKdWJ1Qk.js";const a={};function t(p,s){return e(),l("div",null,s[0]||(s[0]=[i(`<p>css之fill属性:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">对于形状元素和文本，fill 属性是外观属性，用来定义给定图形元素内部的颜色。哪一块算是“内部”取决于形状本身以及fill-rule 属性的值。作为一个外观属性，它可以直接用作 CSS 样式表内部的属性。</span>
