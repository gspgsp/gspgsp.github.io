import{_ as n,c as e,f as a,o as i}from"./app-WR18URC5.js";const l={};function c(r,s){return i(),e("div",null,s[0]||(s[0]=[a(`<p>开发过程中经常要进行代码的合并，然而合并的时候会有冲突，下面通过rebase实现冲突的解决，这个目前是最好的方式:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">git rebase 解决分支冲突的操作[适用于很多分支，很多功能一起开发的场景，前提是在已经知道有冲突的情况下，通过这种方式解决冲突，比如 gitlab下新增了merge request]</span>
