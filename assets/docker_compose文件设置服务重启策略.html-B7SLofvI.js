import{_ as s,c as n,d as a,o as i}from"./app-BHAyGGbM.js";const c={};function l(r,e){return i(),n("div",null,e[0]||(e[0]=[a(`<p>docker_compose文件设置服务重启策略:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">设置 restart: always 确实会使容器在系统重启后自动启动。这个设置的具体作用如下：</span>
