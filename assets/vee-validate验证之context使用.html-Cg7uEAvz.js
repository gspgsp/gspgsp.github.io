import{_ as n,c as s,d as a,o as t}from"./app-CuJfGvbW.js";const i={};function l(c,e){return t(),s("div",null,e[0]||(e[0]=[a(`<p>vee-validate验证之context使用:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">vee-validate验证，通过context获取表单上下文信息:</span>
