import{_ as n,c as s,d as a,o as l}from"./app-S-I12xFq.js";const i={};function t(d,e){return l(),s("div",null,e[0]||(e[0]=[a(`<h4 id="vue3数组引用传递的问题" tabindex="-1"><a class="header-anchor" href="#vue3数组引用传递的问题"><span>vue3数组引用传递的问题</span></a></h4><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">//如下定义了一个ref类型的数组:</span>
