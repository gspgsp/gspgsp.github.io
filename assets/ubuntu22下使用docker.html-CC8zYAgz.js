import{_ as n,c as e,d as i,o as a}from"./app-CgWRetu1.js";const l={};function d(c,s){return a(),e("div",null,s[0]||(s[0]=[i(`<p>ubuntu22下使用docker:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">1&gt;端口映射关系，也适用于直接docker run -p host_port:container_port</span>
