import{_ as n,c as e,f as i,o as a}from"./app-CuipQUN4.js";const l={};function t(c,s){return a(),e("div",null,s[0]||(s[0]=[i(`<p>使用symfony的时候，经常会判断用户角色，常见的就是 是否登录</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">ROLE_ADMIN # 一般会自定义这样一个角色</span>
