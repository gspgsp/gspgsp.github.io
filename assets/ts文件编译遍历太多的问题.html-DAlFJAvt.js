import{_ as n,c as e,d as i,o as a}from"./app-CN0Zwmz6.js";const l={};function t(c,s){return a(),e("div",null,s[0]||(s[0]=[i(`<h5 id="ts文件编译遍历太多的问题" tabindex="-1"><a class="header-anchor" href="#ts文件编译遍历太多的问题"><span>ts文件编译遍历太多的问题</span></a></h5><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">目前问题是，nuxt3项目下，运行tsc --noEmit 之后，定义的server下的$fetch会报如下问题:</span>
