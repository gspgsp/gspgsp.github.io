import{_ as n,c as e,d as a,o as i}from"./app-w2t_O-QA.js";const l={};function c(d,s){return i(),e("div",null,s[0]||(s[0]=[a(`<p>go更新项目依赖版本:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">go mod 管理依赖，但是更新某个依赖的话 需要用到 go get 命令</span>
