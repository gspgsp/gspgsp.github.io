import{_ as n,c as e,d as a,o as i}from"./app-CUXG6XT6.js";const l={};function r(d,s){return i(),e("div",null,s[0]||(s[0]=[a(`<h3 id="使用docker搭建registry仓库" tabindex="-1"><a class="header-anchor" href="#使用docker搭建registry仓库"><span>使用docker搭建registry仓库:</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">1&gt;</span>
