import{_ as n,c as e,f as i,o as a}from"./app-Bo0mKrta.js";const l={};function d(c,s){return a(),e("div",null,s[0]||(s[0]=[i(`<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">在发布镜像的时候，经常要先执行 docker login -u xxx -p xxx 操作，但是在通过脚本发布项目的时候，就会有问题，因为不能直接交互，</span>
