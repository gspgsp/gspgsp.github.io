import{_ as n,c as s,d as a,o as d}from"./app-CBInXF_N.js";const i={};function t(l,e){return d(),s("div",null,e[0]||(e[0]=[a(`<h5 id="基于haproxy-容器-nginx的项目部署" tabindex="-1"><a class="header-anchor" href="#基于haproxy-容器-nginx的项目部署"><span>基于Haproxy+容器+Nginx的项目部署:</span></a></h5><p>最近在看项目部署相关的东西，这些都是实际工作中用到的.</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">首先做了如下部署：</span>
