import{_ as n,c as e,d as l,o as a}from"./app-B4P9BclZ.js";const i={};function d(t,s){return a(),e("div",null,s[0]||(s[0]=[l(`<p>mysql之5.7和8导数据的时候，由于时间戳的默认格式不同导致的问题:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">MySql 8.0中输入代码：</span>
