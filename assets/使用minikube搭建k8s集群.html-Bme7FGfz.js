import{_ as n,c as e,e as l,o as a}from"./app-D80xToMl.js";const i={};function d(c,s){return a(),e("div",null,s[0]||(s[0]=[l(`<p>使用minikube搭建k8s集群:</p><h5 id="安装kubectl" tabindex="-1"><a class="header-anchor" href="#安装kubectl"><span>安装kubectl</span></a></h5><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">https://kubernetes.io/docs/tasks/tools/install-kubectl-linux/</span>
