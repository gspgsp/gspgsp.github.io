import{_ as a,c as n,d as e,o as i}from"./app-CgWRetu1.js";const l={};function r(t,s){return i(),n("div",null,s[0]||(s[0]=[e(`<p>golang之迁移文件管理:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">下载:https://github.com/golang-migrate/migrate  //主要包括cli[单独下载releases下的文件] 模式 和 引入包[go get github.com/golang-migrate/migrate/v4] 模式</span>
