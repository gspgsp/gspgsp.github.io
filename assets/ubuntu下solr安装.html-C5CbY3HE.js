import{_ as n,c as l,d as a,o as i}from"./app-oOCUwQgj.js";const e={};function r(c,s){return i(),l("div",null,s[0]||(s[0]=[a(`<p>ubuntu下solr安装:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">打开下载链接:https://solr.apache.org/downloads.html，我是通过二进制安装的，直接可以执行bin文件</span>
