import{_ as e,c as n,d as a,o as i}from"./app-B4P9BclZ.js";const l={};function c(d,s){return i(),n("div",null,s[0]||(s[0]=[a(`<p>Docker Compose 文件中定义的网络和通过命令行创建的网络的一些区别：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">1. 作用域和生命周期:</span>
