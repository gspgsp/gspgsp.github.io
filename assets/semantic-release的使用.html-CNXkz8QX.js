import{_ as e,c as n,d as a,o as i}from"./app-De-UIJv6.js";const l={};function c(t,s){return i(),n("div",null,s[0]||(s[0]=[a(`<h5 id="semantic-release的使用" tabindex="-1"><a class="header-anchor" href="#semantic-release的使用"><span>semantic-release的使用</span></a></h5><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">1.安装</span>
