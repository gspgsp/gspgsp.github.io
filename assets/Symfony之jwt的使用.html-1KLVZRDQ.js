import{_ as n,c as s,e as a,o as i}from"./app-Dma7cYut.js";const t={};function l(r,e){return i(),s("div",null,e[0]||(e[0]=[a(`<h5 id="symfony之jwt的使用" tabindex="-1"><a class="header-anchor" href="#symfony之jwt的使用"><span>Symfony之jwt的使用:</span></a></h5><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">gesdinet/jwt-refresh-token-bundle 和 lexik/jwt-authentication-bundle 一起使用实现 生成token和 refresh_token操作</span>
