import{_ as s,c as n,f as a,o as i}from"./app-CpoMCvnG.js";const l={};function r(t,e){return i(),n("div",null,e[0]||(e[0]=[a(`<p>vee_validate将API返回的错误渲染到指定File上:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">示例代码:</span>
