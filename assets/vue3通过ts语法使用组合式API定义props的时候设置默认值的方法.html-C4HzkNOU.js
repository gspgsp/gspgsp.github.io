import{_ as n,c as e,h as a,o as i}from"./app-BduoCxtC.js";const l={};function p(c,s){return i(),e("div",null,s[0]||(s[0]=[a(`<p>vue3通过ts语法使用组合式API定义props的时候,设置默认值的方法：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">export interface Props {</span>
