import{_ as n,c as s,d as i,o as a}from"./app-Cl2rcTth.js";const l={};function t(r,e){return a(),s("div",null,e[0]||(e[0]=[i(`<p>gitlab服务器创建分支日志(主要涉及 通过git push 在远程创建分支的记录):</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">k8s@HPDEV-31:~/code/yizhi-frontend-v2$ git push origin yizhi-821:yizhi-821</span>
