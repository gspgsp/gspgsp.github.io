import{_ as s,c as n,d as a,o as l}from"./app-D1FagCFG.js";const t={};function i(r,e){return l(),n("div",null,e[0]||(e[0]=[a(`<h5 id="mysql手动调整字段顺序" tabindex="-1"><a class="header-anchor" href="#mysql手动调整字段顺序"><span>mysql手动调整字段顺序</span></a></h5><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">ALTER TABLE orders MODIFY COLUMN id int NOT NULL AUTO_INCREMENT AFTER title;//这样是可以的</span>
